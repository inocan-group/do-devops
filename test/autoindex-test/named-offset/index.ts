// #autoindex:named-offset, exclude: excludedFolder,excludedFile


// #region autoindexed files

// index last changed at: 10th Oct, 2020, 08:58 AM ( GMT-7 )
// export: namedOffset; exclusions: excludedFolder, excludedFile, index, private.
// files: baz.
// directories: barNamedOffset, fooNamedOffset.

// local file exports
export * as baz from "./baz";

// directory exports
export * as barNamedOffset from "./barNamedOffset/index";
export * as fooNamedOffset from "./fooNamedOffset/index";
