...
const autoindex = `{bgWhite {black autoindex }}`;
...
export const description: IDoDevopsCommand["description"] = {
  ...
  complete: `Automates the building of {italic index} files; if you include a comment starting with {bold {yellow // #autoindex}} in a index file it will be auto-indexed when calling {blue do autoindex}.
