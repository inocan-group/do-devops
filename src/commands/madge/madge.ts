...
const command: IDoDevopsCommand<IMadgeOptions> = {
  ...
  description: `provides a proxy of the highly useful {bold madge} utilities; by default running across all javascript and typescript files in the {blue src} directory.`,
  options,
};
