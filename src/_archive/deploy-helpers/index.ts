...
// index last changed at: 4th Apr, 2021, 09:00 AM ( GMT-7 )
// export: named; exclusions: index, private.
// files: deploy-bespoke, deploy-both, deploy-npm, deploy-serverless, isTranspileNeeded.

// local file exports
export * from "./deploy-bespoke";
export * from "./deploy-both";
export * from "./deploy-npm";
export * from "./deploy-serverless";
export * from "./isTranspileNeeded";
