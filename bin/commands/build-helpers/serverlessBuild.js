...
const index_3 = require("../../shared/serverless/index");
...
function serverlessTranspilation(c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (opts.interactive || argv.length > 0) {
            fns = yield index_2.askForFunctions(validity.invalid.length > 0
        ...
        if (opts.force || fns.length > 0) {
            if (index_2.hasDevDependency("serverless-webpack")) {
            ...
            console.log(chalk_1.default `{grey - {bold Note:} you're configured to use {bold "${config.buildTool}}" as your code build tool and do not appear to be
...
function filterOutInvalidFunction(fns) {
    return __awaiter(this, void 0, void 0, function* () {
        const validFns = Object.keys(yield index_3.getLocalServerlessFunctionsFromServerlessYaml());
        const results = {
            valid: [],
            invalid: [],
        ...
        fns.forEach(f => {
            if (f.includes("*") || f.includes("!")) {
                // explicit soft match
                results.explicit = results.explicit.concat(...matcher_1.default(validFns, [f]));
            }
                ...
                // implicit soft match
                results.implicit = results.implicit.concat(...matcher_1.default(validFns, [f, `${f}*`]));
