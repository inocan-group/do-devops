...
function execute(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!region) {
            throw new shared_1.DevopsError(`Getting SSM secrets requires an ${chalk.bold("AWS Region")} and none could be deduced. You can explicitly state this by adding "--region XYZ" to the command.`);
        }
        if (!profile) {
            throw new shared_1.DevopsError(`Getting SSM secrets requires an ${chalk.bold("AWS Profile")} and none could be deduced. You can explicitly state this by adding "--profile XYZ" to the command.`);
        }
        ...
        try {
            for (var secrets_1 = __asyncValues(secrets), secrets_1_1; secrets_1_1 = yield secrets_1.next(), !secrets_1_1.done;) {
                ...
                tableData.push([data.path, data.arn, String(data.version), date_fns_1.format(data.lastUpdated, "dd MMM, yyyy")]);
