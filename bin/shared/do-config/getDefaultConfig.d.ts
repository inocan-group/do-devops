 ...
 * the tin).
 */
export declare function getDefaultConfig(command?: keyof IDoConfig): import("../../@types").IDoGlobalConfig | IDoConfig | import("../../@types").IDoBuildConfig | import("../../@types").IDoPkgConfig;
