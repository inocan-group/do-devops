 ...
 * the tin).
 */
export declare function getDefaultConfig(command?: keyof IDoConfig): IDoConfig | import("../../@types").IDoPkgConfig | import("../../@types").IDoGlobalConfig | import("../../@types").IDoBuildConfig;
