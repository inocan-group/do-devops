 ...
 * the tin).
 */
export declare function getDefaultConfig(command?: keyof IDoConfig): import("../../@types").IDoBuildConfig | IDoConfig | import("../../@types").IDoGlobalConfig | import("../../@types").IDoPkgConfig;
