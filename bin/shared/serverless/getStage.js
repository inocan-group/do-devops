...
const getAwsProfileFromServerless_1 = require("./getAwsProfileFromServerless");
 ...
 */
function getStage(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const profile = yield getAwsProfileFromServerless_1.getAwsProfileFromServerless();
